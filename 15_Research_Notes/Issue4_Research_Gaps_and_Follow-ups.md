# Issue #4: Research Gaps and Follow-ups

Prepared by Member 4 (Research & History). Applies to `EKITI30_Timeline_Events_1996-2026.csv` (50 events).

## 1. Coverage gaps (documented, not blocking)

| Category | Entries | Gap |
|---|---|---|
| Agriculture | 1 (EK-048) | No verified programme dates. Cocoa and cassava revitalisation, SAPZ, dairy and livestock projects are unsourced. Try the Ekiti Ministry of Agriculture, NBS agriculture data and budget documents. |
| Sports | 1 (EK-049) | No medals, hosting rights or facility completion dates. Try the Ekiti State Sports Council and National Sports Festival records. |
| Culture | 3 (EK-039, EK-045, EK-050) | Only Udiroko and the Ewi of Ado-Ekiti. Olosunta (Ikere), Odun Oba, Ita Ijero, Okorobo, Ajagbo, Epa and others need dates and authoritative sources. Coordinate with Member 7 (issue #7). |
| Health | 6 | Little on primary care, outbreaks or health-insurance rollout dates. |
| Education | 5 | No statistics (enrolment, WAEC results). Free-education and scholarship schemes are unsourced. |
| Population and geography | 1 (EK-008) | The 2006 census total for Ekiti is unresolved. Coordinate with Member 5 (issue #5). |

Items in the earlier outline still unsourced: Ekiti State Civic Centre (2016); Ado-Ikere-Akure road upgrades (2018-2021); EKSU Teaching Hospital expansion; Ekiti Parapo War remembrance; official origin of the "Fountain of Knowledge" nickname; Federal Polytechnic Ado-Ekiti and Ekiti State Polytechnic history.

## 2. Primary-source follow-ups

Status as of this revision. "Done" means an official or institutional source now supports the claim as written.

| ID | Entry | Status | Still needed |
|---|---|---|---|
| EK-002, 003, 005, 011 | Bawa, Yusuf, Adebayo, Ademiluyi | Verified (state past-governors list) | Optional: gazette copies |
| EK-004 | FMC Ido-Ekiti established 1998 | Needs primary source | Hospital's own history page (fethi.gov.ng) |
| EK-010 | Olurin administrator | Verified for dates; emergency details unconfirmed | Presidency or National Assembly record of the emergency and ratification |
| EK-017 | FUOYE established 2011 | Verified (university site) | None |
...
EK-008 (2006 census totals), EK-009 (day of the 2006 impeachment), EK-035 (year of the airport's ceremonial commissioning), EK-036 (year of the Ikogosi concession). Basis for each is in `notes_limitations` and `claim_source_map`.
