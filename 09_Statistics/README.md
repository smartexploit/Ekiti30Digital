...
- `kb_manifest_statistics_rows.csv` — 19 verified source rows, same column order as other sector manifests (doc_id, source_title, source_url, class, tier, last_verified, ingestible).
